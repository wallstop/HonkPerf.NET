...
namespace HonkPerf.NET.RefLinq
{
    ...
    public static partial class ActiveLinqExtensions
    {
        ...
        public static T MaxBy<T, TBy, TDelegate, TEnumerator>(this RefLinqEnumerable<T, TEnumerator> seq,
            TDelegate func)
        ...
        public static T MaxBy<T, TBy, TCapture, TEnumerator>(this RefLinqEnumerable<T, TEnumerator> seq,
            Func<T, TCapture, TBy> func, TCapture capture)
            where TEnumerator : IRefEnumerable<T>
            where TBy : unmanaged
