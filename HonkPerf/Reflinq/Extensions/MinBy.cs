...
namespace HonkPerf.NET.RefLinq
{
    ...
    public static partial class ActiveLinqExtensions
    {
        ...
        public static T MinBy<T, TBy, TDelegate, TEnumerator>(this RefLinqEnumerable<T, TEnumerator> seq,
            TDelegate func)
        ...
        public static T MinBy<T, TBy, TCapture, TEnumerator>(this RefLinqEnumerable<T, TEnumerator> seq,
