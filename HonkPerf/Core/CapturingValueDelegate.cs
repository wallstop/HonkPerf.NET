...
namespace HonkPerf.NET.Core
{
    ...
    public struct
        CapturingValueDelegate<TIn1, TIn2, TIn3, TIn4, TCapture, TOut> : IValueDelegate<TIn1, TIn2, TIn3, TIn4, TOut>
    {
        private readonly TCapture capture;
    ...
    public struct
        CapturingValueDelegate<TIn1, TIn2, TIn3, TIn4, TIn5, TCapture, TOut> : IValueDelegate<TIn1, TIn2, TIn3, TIn4,
            TIn5, TOut>
    {
        private readonly TCapture capture;
